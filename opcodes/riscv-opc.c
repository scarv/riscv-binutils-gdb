...
{"xc.init",          0, {"X",0}, "",                    MATCH_INIT   , MASK_INIT   , match_opcode, 0},
{"xc.padd",          0, {"X",0}, "Xp,XD,Xs,Xt",         MATCH_PADD, MASK_PADD, match_opcode, 0},
{"xc.psub",          0, {"X",0}, "Xp,XD,Xs,Xt",         MATCH_PSUB, MASK_PSUB, match_opcode, 0},
{"xc.pmul.l",        0, {"X",0}, "Xp,XD,Xs,Xt",         MATCH_PMUL_L, MASK_PMUL_L, match_opcode, 0},
{"xc.pmul.h",        0, {"X",0}, "Xp,XD,Xs,Xt",         MATCH_PMUL_H, MASK_PMUL_H, match_opcode, 0},
{"xc.pclmul.l",      0, {"X",0}, "Xp,XD,Xs,Xt",         MATCH_PCLMUL_L, MASK_PCLMUL_L, match_opcode, 0},
{"xc.pclmul.h",      0, {"X",0}, "Xp,XD,Xs,Xt",         MATCH_PCLMUL_H, MASK_PCLMUL_H, match_opcode, 0},
{"xc.psll",          0, {"X",0}, "Xp,XD,Xs,Xt",         MATCH_PSLL, MASK_PSLL, match_opcode, 0},
{"xc.psrl",          0, {"X",0}, "Xp,XD,Xs,Xt",         MATCH_PSRL, MASK_PSRL, match_opcode, 0},
{"xc.prot",          0, {"X",0}, "Xp,XD,Xs,Xt",         MATCH_PROT, MASK_PROT, match_opcode, 0},
{"xc.psll.i",        0, {"X",0}, "Xp,XD,Xs,XR",         MATCH_PSLL_I, MASK_PSLL_I, match_opcode, 0},
{"xc.psrl.i",        0, {"X",0}, "Xp,XD,Xs,XR",         MATCH_PSRL_I, MASK_PSRL_I, match_opcode, 0},
{"xc.prot.i",        0, {"X",0}, "Xp,XD,Xs,XR",         MATCH_PROT_I, MASK_PROT_I, match_opcode, 0},
{"xc.rngseed",       0, {"X",0}, "Xs",                  MATCH_RNGSEED, MASK_RNGSEED, match_opcode, 0},
{"xc.rngsamp",       0, {"X",0}, "XD",                  MATCH_RNGSAMP, MASK_RNGSAMP, match_opcode, 0},
{"xc.rngtest",       0, {"X",0}, "d",                   MATCH_RNGTEST, MASK_RNGTEST, match_opcode, 0},
{"xc.cmov.t",        0, {"X",0}, "XD,Xs,Xt",            MATCH_CMOV_T, MASK_CMOV_T, match_opcode, 0},
{"xc.cmov.f",        0, {"X",0}, "XD,Xs,Xt",            MATCH_CMOV_F, MASK_CMOV_F, match_opcode, 0},
{"xc.sha3.xy",       0, {"X",0}, "d,s,t,Xw",            MATCH_SHA3_XY, MASK_SHA3_XY, match_opcode, 0},
{"xc.sha3.x1",       0, {"X",0}, "d,s,t,Xw",            MATCH_SHA3_X1, MASK_SHA3_X1, match_opcode, 0},
{"xc.sha3.x2",       0, {"X",0}, "d,s,t,Xw",            MATCH_SHA3_X2, MASK_SHA3_X2, match_opcode, 0},
{"xc.sha3.x4",       0, {"X",0}, "d,s,t,Xw",            MATCH_SHA3_X4, MASK_SHA3_X4, match_opcode, 0},
{"xc.sha3.yx",       0, {"X",0}, "d,s,t,Xw",            MATCH_SHA3_YX, MASK_SHA3_YX, match_opcode, 0},
{"xc.aessub.enc"   , 0, {"X",0}, "XD,Xs,Xt",            MATCH_AESSUB_ENC, MASK_AESSUB_ENC, match_opcode, 0},
{"xc.aessub.encrot", 0, {"X",0}, "XD,Xs,Xt",            MATCH_AESSUB_ENCROT, MASK_AESSUB_ENCROT, match_opcode, 0},
{"xc.aessub.dec"   , 0, {"X",0}, "XD,Xs,Xt",            MATCH_AESSUB_DEC, MASK_AESSUB_DEC, match_opcode, 0},
{"xc.aessub.decrot", 0, {"X",0}, "XD,Xs,Xt",            MATCH_AESSUB_DECROT, MASK_AESSUB_DECROT, match_opcode, 0},
{"xc.aesmix.enc"   , 0, {"X",0}, "XD,Xs,Xt",            MATCH_AESMIX_ENC, MASK_AESMIX_ENC, match_opcode, 0},
{"xc.aesmix.dec"   , 0, {"X",0}, "XD,Xs,Xt",            MATCH_AESMIX_DEC, MASK_AESMIX_DEC, match_opcode, 0},
{"xc.scatter.b",     0, {"X",0}, "XD,Xt,s",             MATCH_SCATTER_B, MASK_SCATTER_B, match_opcode, 0},
{"xc.gather.b",      0, {"X",0}, "XD,Xt,s",             MATCH_GATHER_B, MASK_GATHER_B, match_opcode, 0},
{"xc.scatter.h",     0, {"X",0}, "XD,Xt,s",             MATCH_SCATTER_H, MASK_SCATTER_H, match_opcode, 0},
{"xc.gather.h",      0, {"X",0}, "XD,Xt,s",             MATCH_GATHER_H, MASK_GATHER_H, match_opcode, 0},
{"xc.bop",           0, {"X",0}, "XD,Xs,Xt,X8",         MATCH_BOP, MASK_BOP, match_opcode, 0},
{"xc.mequ",          0, {"X",0}, "d,s,Xt,XS",           MATCH_MEQU, MASK_MEQU, match_opcode, 0},
{"xc.mlte",          0, {"X",0}, "d,s,Xt,XS",           MATCH_MLTE, MASK_MLTE, match_opcode, 0},
{"xc.mgte",          0, {"X",0}, "d,s,Xt,XS",           MATCH_MGTE, MASK_MGTE, match_opcode, 0},
{"xc.lut",           0, {"X",0}, "XD,Xs,Xt,XS",         MATCH_LUT   , MASK_LUT   , match_opcode, 0},
{"xc.madd.3",        0, {"X",0}, "(XM),Xs,Xt,XS",       MATCH_MADD_3, MASK_MADD_3, match_opcode, 0},
{"xc.madd.2",        0, {"X",0}, "(XM),Xs,Xt",          MATCH_MADD_2, MASK_MADD_2, match_opcode, 0},
{"xc.msub.3",        0, {"X",0}, "(XM),Xs,Xt,XS",       MATCH_MSUB_3, MASK_MSUB_3, match_opcode, 0},
{"xc.msub.2",        0, {"X",0}, "(XM),Xs,Xt",          MATCH_MSUB_2, MASK_MSUB_2, match_opcode, 0},
{"xc.msll.i",        0, {"X",0}, "(XM),Xs,Xt,Xr",       MATCH_MSLL_I, MASK_MSLL_I, match_opcode, 0},
{"xc.msll",          0, {"X",0}, "(XM),Xs,Xt,XS",       MATCH_MSLL, MASK_MSLL, match_opcode, 0},
{"xc.msrl.i",        0, {"X",0}, "(XM),Xs,Xt,Xr",       MATCH_MSRL_I, MASK_MSRL_I, match_opcode, 0},
{"xc.msrl",          0, {"X",0}, "(XM),Xs,Xt,XS",       MATCH_MSRL, MASK_MSRL, match_opcode, 0},
{"xc.macc.2",        0, {"X",0}, "(XM),Xs,Xt",          MATCH_MACC_2, MASK_MACC_2, match_opcode, 0},
{"xc.macc.1",        0, {"X",0}, "(XM),Xs",             MATCH_MACC_1, MASK_MACC_1, match_opcode, 0},
{"xc.mmul.3",        0, {"X",0}, "(XM),Xs,Xt,XS",       MATCH_MMUL_3, MASK_MMUL_3, match_opcode, 0},
{"xc.mclmul.3",      0, {"X",0}, "(XM),Xs,Xt,XS",       MATCH_MCLMUL_3, MASK_MCLMUL_3, match_opcode, 0},
{"xc.ld.bu",         0, {"X",0}, "XD,(Xh,Xd),Xl(s)",    MATCH_LD_BU, MASK_LD_BU, match_opcode, 0},
{"xc.ld.hu",         0, {"X",0}, "XD,(Xh),Xl(s)",       MATCH_LD_HU, MASK_LD_HU, match_opcode, 0},
{"xc.ld.w",          0, {"X",0}, "XD,Xl(s)",            MATCH_LD_W, MASK_LD_W, match_opcode, 0},
{"xc.ld.hiu",        0, {"X",0}, "XD,X5",               MATCH_LD_HIU, MASK_LD_HIU, match_opcode, 0},
{"xc.ld.liu",        0, {"X",0}, "XD,X5",               MATCH_LD_LIU, MASK_LD_LIU, match_opcode, 0},
{"xc.ldr.bu",        0, {"X",0}, "XD(Xw),s,t",          MATCH_LDR_BU, MASK_LDR_BU, match_opcode, 0},
{"xc.ldr.hu",        0, {"X",0}, "XD(Xw),s,t",          MATCH_LDR_HU, MASK_LDR_HU, match_opcode, 0},
{"xc.ldr.w",         0, {"X",0}, "XD,s,t",              MATCH_LDR_W , MASK_LDR_W , match_opcode, 0},
{"xc.str.b",         0, {"X",0}, "XD(Xw),s,t",          MATCH_STR_B , MASK_STR_B , match_opcode, 0},
{"xc.str.h",         0, {"X",0}, "XD(Xw),s,t",          MATCH_STR_H , MASK_STR_H , match_opcode, 0},
{"xc.str.w",         0, {"X",0}, "XD,s,t",              MATCH_STR_W , MASK_STR_W , match_opcode, 0},
{"xc.pbyte",         0, {"X",0}, "XD,Xs,Xw,Xx,Xy,Xz",   MATCH_PBYTE  , MASK_PBYTE  , match_opcode, 0},
{"xc.pbit",          0, {"X",0}, "XD,Xs,Xk",            MATCH_PBIT   , MASK_PBIT   , match_opcode, 0},
{"xc.ipbit",         0, {"X",0}, "XD,Xs,Xk",            MATCH_IPBIT  , MASK_IPBIT  , match_opcode, 0},
{"xc.bmv",           0, {"X",0}, "XD,Xs,Xk,XL",         MATCH_BMV, MASK_BMV, match_opcode, 0},
{"xc.ins",           0, {"X",0}, "XD,Xs,Xk,XL",         MATCH_INS, MASK_INS, match_opcode, 0},
{"xc.ext",           0, {"X",0}, "XD,Xs,Xk,XL",         MATCH_EXT, MASK_EXT, match_opcode, 0},
{"xc.st.b",          0, {"X",0}, "Xt,(Xh,XB),Xm(s)",    MATCH_ST_B, MASK_ST_B, match_opcode, 0},
{"xc.st.h",          0, {"X",0}, "Xt,(Xh),Xm(s)",       MATCH_ST_H, MASK_ST_H, match_opcode, 0},
{"xc.st.w",          0, {"X",0}, "Xt,Xm(s)",            MATCH_ST_W, MASK_ST_W, match_opcode, 0},
// ----- XCrypto ISE END -------
