...
{        "xc.mmul.3", 0, {"I",0}, "XM,s,t,r", MATCH_XC_MMUL_3, MASK_XC_MMUL_3, match_opcode, 0},
{        "xc.macc.1", 0, {"I",0}, "XM,s,t,r", MATCH_XC_MACC_1, MASK_XC_MACC_1, match_opcode, 0},
{        "xc.madd.3", 0, {"I",0}, "XM,s,t,r", MATCH_XC_MADD_3, MASK_XC_MADD_3, match_opcode, 0},
{        "xc.msub.3", 0, {"I",0}, "XM,s,t,r", MATCH_XC_MSUB_3, MASK_XC_MSUB_3, match_opcode, 0},
...
{          "xc.padd", 0, {"I",0}, "d,s,t,Xp", MATCH_XC_PADD, MASK_XC_PADD, match_opcode, 0},
{          "xc.psub", 0, {"I",0}, "d,s,t,Xp", MATCH_XC_PSUB, MASK_XC_PSUB, match_opcode, 0},
{          "xc.pror", 0, {"I",0}, "d,s,t,Xp", MATCH_XC_PROR, MASK_XC_PROR, match_opcode, 0},
{          "xc.psll", 0, {"I",0}, "d,s,t,Xp", MATCH_XC_PSLL, MASK_XC_PSLL, match_opcode, 0},
{          "xc.psrl", 0, {"I",0}, "d,s,t,Xp", MATCH_XC_PSRL, MASK_XC_PSRL, match_opcode, 0},
{        "xc.pror.i", 0, {"I",0}, "d,s,Xp,<", MATCH_XC_PROR_I, MASK_XC_PROR_I, match_opcode, 0},
{        "xc.psll.i", 0, {"I",0}, "d,s,Xp,<", MATCH_XC_PSLL_I, MASK_XC_PSLL_I, match_opcode, 0},
{        "xc.psrl.i", 0, {"I",0}, "d,s,Xp,<", MATCH_XC_PSRL_I, MASK_XC_PSRL_I, match_opcode, 0},
{        "xc.pmul.l", 0, {"I",0}, "d,s,t,Xp", MATCH_XC_PMUL_L, MASK_XC_PMUL_L, match_opcode, 0},
{        "xc.pmul.h", 0, {"I",0}, "d,s,t,Xp", MATCH_XC_PMUL_H, MASK_XC_PMUL_H, match_opcode, 0},
{      "xc.pclmul.l", 0, {"I",0}, "d,s,t,Xp", MATCH_XC_PCLMUL_L, MASK_XC_PCLMUL_L, match_opcode, 0},
{      "xc.pclmul.h", 0, {"I",0}, "d,s,t,Xp", MATCH_XC_PCLMUL_H, MASK_XC_PCLMUL_H, match_opcode, 0},
...
{       "xc.sha3.xy", 0, {"I",0}, "d,s,t,Xp", MATCH_XC_SHA3_XY, MASK_XC_SHA3_XY, match_opcode, 0},
{       "xc.sha3.x1", 0, {"I",0}, "d,s,t,Xp", MATCH_XC_SHA3_X1, MASK_XC_SHA3_X1, match_opcode, 0},
{       "xc.sha3.x2", 0, {"I",0}, "d,s,t,Xp", MATCH_XC_SHA3_X2, MASK_XC_SHA3_X2, match_opcode, 0},
{       "xc.sha3.x4", 0, {"I",0}, "d,s,t,Xp", MATCH_XC_SHA3_X4, MASK_XC_SHA3_X4, match_opcode, 0},
{       "xc.sha3.yx", 0, {"I",0}, "d,s,t,Xp", MATCH_XC_SHA3_YX, MASK_XC_SHA3_YX, match_opcode, 0},
