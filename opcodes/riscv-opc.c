...
{         "xc.ldr.b", 0, {"X",0},   "d,s(t)", MATCH_XC_LDR_B, MASK_XC_LDR_B, match_opcode, 0},
{         "xc.ldr.h", 0, {"X",0},   "d,s(t)", MATCH_XC_LDR_H, MASK_XC_LDR_H, match_opcode, 0},
{         "xc.ldr.w", 0, {"X",0},   "d,s(t)", MATCH_XC_LDR_W, MASK_XC_LDR_W, match_opcode, 0},
{         "xc.ldr.d",64, {"X",0},   "d,s(t)", MATCH_XC_LDR_D, MASK_XC_LDR_D, match_opcode, 0},
{        "xc.ldr.bu", 0, {"X",0},   "d,s(t)", MATCH_XC_LDR_BU, MASK_XC_LDR_BU, match_opcode, 0},
{        "xc.ldr.hu", 0, {"X",0},   "d,s(t)", MATCH_XC_LDR_HU, MASK_XC_LDR_HU, match_opcode, 0},
{        "xc.ldr.wu",64, {"X",0},   "d,s(t)", MATCH_XC_LDR_WU, MASK_XC_LDR_WU, match_opcode, 0},
{         "xc.str.b", 0, {"X",0},   "r,s(t)", MATCH_XC_STR_B, MASK_XC_STR_B, match_opcode, 0},
{         "xc.str.h", 0, {"X",0},   "r,s(t)", MATCH_XC_STR_H, MASK_XC_STR_H, match_opcode, 0},
{         "xc.str.w", 0, {"X",0},   "r,s(t)", MATCH_XC_STR_W, MASK_XC_STR_W, match_opcode, 0},
{         "xc.str.d",64, {"X",0},   "r,s(t)", MATCH_XC_STR_D, MASK_XC_STR_D, match_opcode, 0},
{        "xc.mmul.3", 0, {"X",0}, "XM,s,t,r", MATCH_XC_MMUL_3, MASK_XC_MMUL_3, match_opcode, 0},
{        "xc.macc.1", 0, {"X",0}, "XM,s,t,r", MATCH_XC_MACC_1, MASK_XC_MACC_1, match_opcode, 0},
{        "xc.madd.3", 0, {"X",0}, "XM,s,t,r", MATCH_XC_MADD_3, MASK_XC_MADD_3, match_opcode, 0},
{        "xc.msub.3", 0, {"X",0}, "XM,s,t,r", MATCH_XC_MSUB_3, MASK_XC_MSUB_3, match_opcode, 0},
{       "xc.rngtest", 0, {"X",0},        "d", MATCH_XC_RNGTEST, MASK_XC_RNGTEST, match_opcode, 0},
{       "xc.rngsamp", 0, {"X",0},        "d", MATCH_XC_RNGSAMP, MASK_XC_RNGSAMP, match_opcode, 0},
{       "xc.rngseed", 0, {"X",0},        "s", MATCH_XC_RNGSEED, MASK_XC_RNGSEED, match_opcode, 0},
{           "xc.lut", 0, {"X",0},    "d,s,t", MATCH_XC_LUT, MASK_XC_LUT, match_opcode, 0},
{          "xc.padd", 0, {"X",0}, "d,s,t,Xp", MATCH_XC_PADD, MASK_XC_PADD, match_opcode, 0},
{          "xc.psub", 0, {"X",0}, "d,s,t,Xp", MATCH_XC_PSUB, MASK_XC_PSUB, match_opcode, 0},
{          "xc.pror", 0, {"X",0}, "d,s,t,Xp", MATCH_XC_PROR, MASK_XC_PROR, match_opcode, 0},
{          "xc.psll", 0, {"X",0}, "d,s,t,Xp", MATCH_XC_PSLL, MASK_XC_PSLL, match_opcode, 0},
{          "xc.psrl", 0, {"X",0}, "d,s,t,Xp", MATCH_XC_PSRL, MASK_XC_PSRL, match_opcode, 0},
{        "xc.pror.i", 0, {"X",0}, "d,s,Xp,<", MATCH_XC_PROR_I, MASK_XC_PROR_I, match_opcode, 0},
{        "xc.psll.i", 0, {"X",0}, "d,s,Xp,<", MATCH_XC_PSLL_I, MASK_XC_PSLL_I, match_opcode, 0},
{        "xc.psrl.i", 0, {"X",0}, "d,s,Xp,<", MATCH_XC_PSRL_I, MASK_XC_PSRL_I, match_opcode, 0},
{        "xc.pmul.l", 0, {"X",0}, "d,s,t,Xp", MATCH_XC_PMUL_L, MASK_XC_PMUL_L, match_opcode, 0},
{        "xc.pmul.h", 0, {"X",0}, "d,s,t,Xp", MATCH_XC_PMUL_H, MASK_XC_PMUL_H, match_opcode, 0},
{      "xc.pclmul.l", 0, {"X",0}, "d,s,t,Xp", MATCH_XC_PCLMUL_L, MASK_XC_PCLMUL_L, match_opcode, 0},
{      "xc.pclmul.h", 0, {"X",0}, "d,s,t,Xp", MATCH_XC_PCLMUL_H, MASK_XC_PCLMUL_H, match_opcode, 0},
{     "xc.scatter.b", 0, {"X",0},    "s,t,r", MATCH_XC_SCATTER_B, MASK_XC_SCATTER_B, match_opcode, 0},
{     "xc.scatter.h", 0, {"X",0},    "s,t,r", MATCH_XC_SCATTER_H, MASK_XC_SCATTER_H, match_opcode, 0},
{      "xc.gather.b", 0, {"X",0},    "d,s,t", MATCH_XC_GATHER_B, MASK_XC_GATHER_B, match_opcode, 0},
{      "xc.gather.h", 0, {"X",0},    "d,s,t", MATCH_XC_GATHER_H, MASK_XC_GATHER_H, match_opcode, 0},
{    "xc.aessub.enc", 0, {"X",0},    "s,t,d", MATCH_XC_AESSUB_ENC, MASK_XC_AESSUB_ENC, match_opcode, 0},
{ "xc.aessub.encrot", 0, {"X",0},    "s,t,d", MATCH_XC_AESSUB_ENCROT, MASK_XC_AESSUB_ENCROT, match_opcode, 0},
{    "xc.aessub.dec", 0, {"X",0},    "s,t,d", MATCH_XC_AESSUB_DEC, MASK_XC_AESSUB_DEC, match_opcode, 0},
{ "xc.aessub.decrot", 0, {"X",0},    "s,t,d", MATCH_XC_AESSUB_DECROT, MASK_XC_AESSUB_DECROT, match_opcode, 0},
{    "xc.aesmix.enc", 0, {"X",0},    "s,t,d", MATCH_XC_AESMIX_ENC, MASK_XC_AESMIX_ENC, match_opcode, 0},
{    "xc.aesmix.dec", 0, {"X",0},    "s,t,d", MATCH_XC_AESMIX_DEC, MASK_XC_AESMIX_DEC, match_opcode, 0},
{       "xc.sha3.xy", 0, {"X",0}, "d,s,t,Xp", MATCH_XC_SHA3_XY, MASK_XC_SHA3_XY, match_opcode, 0},
{       "xc.sha3.x1", 0, {"X",0}, "d,s,t,Xp", MATCH_XC_SHA3_X1, MASK_XC_SHA3_X1, match_opcode, 0},
{       "xc.sha3.x2", 0, {"X",0}, "d,s,t,Xp", MATCH_XC_SHA3_X2, MASK_XC_SHA3_X2, match_opcode, 0},
{       "xc.sha3.x4", 0, {"X",0}, "d,s,t,Xp", MATCH_XC_SHA3_X4, MASK_XC_SHA3_X4, match_opcode, 0},
{       "xc.sha3.yx", 0, {"X",0}, "d,s,t,Xp", MATCH_XC_SHA3_YX, MASK_XC_SHA3_YX, match_opcode, 0},
{     "xc.sha256.s0", 0, {"X",0},      "d,s", MATCH_XC_SHA256_S0, MASK_XC_SHA256_S0, match_opcode, 0},
{     "xc.sha256.s1", 0, {"X",0},      "d,s", MATCH_XC_SHA256_S1, MASK_XC_SHA256_S1, match_opcode, 0},
{     "xc.sha256.s2", 0, {"X",0},      "d,s", MATCH_XC_SHA256_S2, MASK_XC_SHA256_S2, match_opcode, 0},
{     "xc.sha256.s3", 0, {"X",0},      "d,s", MATCH_XC_SHA256_S3, MASK_XC_SHA256_S3, match_opcode, 0},
{     "xc.sha512.s0",64, {"X",0},      "d,s", MATCH_XC_SHA512_S0, MASK_XC_SHA512_S0, match_opcode, 0},
{     "xc.sha512.s1",64, {"X",0},      "d,s", MATCH_XC_SHA512_S1, MASK_XC_SHA512_S1, match_opcode, 0},
{     "xc.sha512.s2",64, {"X",0},      "d,s", MATCH_XC_SHA512_S2, MASK_XC_SHA512_S2, match_opcode, 0},
{     "xc.sha512.s3",64, {"X",0},      "d,s", MATCH_XC_SHA512_S3, MASK_XC_SHA512_S3, match_opcode, 0},
