...
{         "mask.b2a", 0, {"X",0}, "(XM,XN),(XO,XP)", MATCH_MASK_B2A, MASK_MASK_B2A, match_opcode, 0},
{         "mask.a2b", 0, {"X",0}, "(XM,XN),(XO,XP)", MATCH_MASK_A2B, MASK_MASK_A2B, match_opcode, 0},
{      "mask.b.mask", 0, {"X",0}, "(XM,XN),s", MATCH_MASK_B_MASK, MASK_MASK_B_MASK, match_opcode, 0},
{    "mask.b.unmask", 0, {"X",0}, "d,(XO,XP)", MATCH_MASK_B_UNMASK, MASK_MASK_B_UNMASK, match_opcode, 0},
{    "mask.b.remask", 0, {"X",0}, "(XM,XN),(XO,XP)", MATCH_MASK_B_REMASK, MASK_MASK_B_REMASK, match_opcode, 0},
{      "mask.a.mask", 0, {"X",0}, "(XM,XN),s", MATCH_MASK_A_MASK, MASK_MASK_A_MASK, match_opcode, 0},
{    "mask.a.unmask", 0, {"X",0}, "d,(XO,XP)", MATCH_MASK_A_UNMASK, MASK_MASK_A_UNMASK, match_opcode, 0},
{    "mask.a.remask", 0, {"X",0}, "(XM,XN),(XO,XP)", MATCH_MASK_A_REMASK, MASK_MASK_A_REMASK, match_opcode, 0},
{       "mask.b.not", 0, {"X",0}, "(XM,XN),(XO,XP)", MATCH_MASK_B_NOT, MASK_MASK_B_NOT, match_opcode, 0},
{       "mask.b.and", 0, {"X",0}, "(XM,XN),(XO,XP),(XQ,XR)", MATCH_MASK_B_AND, MASK_MASK_B_AND, match_opcode, 0},
{       "mask.b.ior", 0, {"X",0}, "(XM,XN),(XO,XP),(XQ,XR)", MATCH_MASK_B_IOR, MASK_MASK_B_IOR, match_opcode, 0},
{       "mask.b.xor", 0, {"X",0}, "(XM,XN),(XO,XP),(XQ,XR)", MATCH_MASK_B_XOR, MASK_MASK_B_XOR, match_opcode, 0},
{       "mask.b.add", 0, {"X",0}, "(XM,XN),(XO,XP),(XQ,XR)", MATCH_MASK_B_ADD, MASK_MASK_B_ADD, match_opcode, 0},
{       "mask.b.sub", 0, {"X",0}, "(XM,XN),(XO,XP),(XQ,XR)", MATCH_MASK_B_SUB, MASK_MASK_B_SUB, match_opcode, 0},
