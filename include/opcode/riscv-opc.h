...
// ----- Crypto ISE BEGIN -----
#define MATCH_XCR2GPR 0x1000002b
#define MASK_XCR2GPR  0xfff8707f
#define MATCH_GPR2XCR 0x1100002b
#define MASK_GPR2XCR  0xfff0787f
#define MATCH_INIT 0x1110082b
#define MASK_INIT  0xffffffff
#define MATCH_PADD 0x600002b
#define MASK_PADD  0x1f08787f
#define MATCH_PSUB 0x600082b
#define MASK_PSUB  0x1f08787f
#define MATCH_PMUL_L 0xe00002b
#define MASK_PMUL_L  0x1f08787f
#define MATCH_PMUL_H 0xe00082b
#define MASK_PMUL_H  0x1f08787f
#define MATCH_PCLMUL_L 0xe08002b
#define MASK_PCLMUL_L  0x1f08787f
#define MATCH_PCLMUL_H 0xe08082b
#define MASK_PCLMUL_H  0x1f08787f
#define MATCH_PSLL 0x1600002b
#define MASK_PSLL  0x1f08787f
#define MATCH_PSRL 0x1600082b
#define MASK_PSRL  0x1f08787f
#define MATCH_PROT 0x1608082b
#define MASK_PROT  0x1f08787f
#define MATCH_PSLL_I 0x1e00002b
#define MASK_PSLL_I  0x1e08787f
#define MATCH_PSRL_I 0x1e00082b
#define MASK_PSRL_I  0x1e08787f
#define MATCH_PROT_I 0x1e08082b
#define MASK_PROT_I  0x1e08787f
#define MATCH_RNGSEED 0x800002b
#define MASK_RNGSEED  0xfff87fff
#define MATCH_RNGSAMP 0x810082b
#define MASK_RNGSAMP  0xfffff87f
#define MATCH_RNGTEST 0x820002b
#define MASK_RNGTEST  0xfffff07f
#define MATCH_CMOV_T 0x1800082b
#define MASK_CMOV_T  0xff08787f
#define MATCH_CMOV_F 0x1800002b
#define MASK_CMOV_F  0xff08787f
#define MATCH_SHA3_XY 0xc00002b
#define MASK_SHA3_XY  0x3e00707f
#define MATCH_SHA3_X1 0x1400002b
#define MASK_SHA3_X1  0x3e00707f
#define MATCH_SHA3_X2 0x2400002b
#define MASK_SHA3_X2  0x3e00707f
#define MATCH_SHA3_X4 0x1c00002b
#define MASK_SHA3_X4  0x3e00707f
#define MATCH_SHA3_YX 0x3400002b
#define MASK_SHA3_YX  0x3e00707f
#define MATCH_AESSUB_ENC 0x400002b
#define MASK_AESSUB_ENC  0xff08787f
#define MATCH_AESSUB_ENCROT 0x400082b
#define MASK_AESSUB_ENCROT  0xff08787f
#define MATCH_AESSUB_DEC 0x408002b
#define MASK_AESSUB_DEC  0xff08787f
#define MATCH_AESSUB_DECROT 0x408082b
#define MASK_AESSUB_DECROT  0xff08787f
#define MATCH_AESMIX_ENC 0x500002b
#define MASK_AESMIX_ENC  0xff08787f
#define MATCH_AESMIX_DEC 0x508002b
#define MASK_AESMIX_DEC  0xff08787f
#define MATCH_SCATTER_B 0xa00082b
#define MASK_SCATTER_B  0xff00787f
#define MATCH_GATHER_B 0xa00002b
#define MASK_GATHER_B  0xff00787f
#define MATCH_SCATTER_H 0xb00082b
#define MASK_SCATTER_H  0xff00787f
#define MATCH_GATHER_H 0xb00002b
...
#define MATCH_LDR_BU 0x200002b
#define MASK_LDR_BU  0x3e00787f
#define MATCH_LDR_HU 0x1200002b
#define MASK_LDR_HU  0x3e00787f
#define MATCH_LDR_W 0x2200002b
#define MASK_LDR_W  0xfe00787f
#define MATCH_STR_B 0x200082b
#define MASK_STR_B  0x3e00787f
#define MATCH_STR_H 0x1200082b
#define MASK_STR_H  0x3e00787f
#define MATCH_STR_W 0x2200082b
#define MASK_STR_W  0xfe00787f
#define MATCH_IPBIT 0x10202b
#define MASK_IPBIT  0x7f8787f
#define MATCH_PBIT  0x10282b
#define MASK_PBIT   0x7f8787f
#define MATCH_PBYTE 0x30202b
#define MASK_PBYTE  0xf8787f
#define MATCH_INS   0x30282b
#define MASK_INS    0x38787f
#define MATCH_BMV   0x38202b
#define MASK_BMV    0x38787f
#define MATCH_EXT   0x38282b
#define MASK_EXT    0x38787f
